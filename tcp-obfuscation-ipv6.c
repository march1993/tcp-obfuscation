...
static int __init init_tcp_obfuscation_ipv6(void)
{
	...
	nf_register_hook(&tcp_obfuscation_ops_ipv6_incoming);
	nf_register_hook(&tcp_obfuscation_ops_ipv6_outgoing);
...
static void __exit exit_tcp_obfuscation_ipv6(void)
{
	...
	nf_unregister_hook(&tcp_obfuscation_ops_ipv6_incoming);
	nf_unregister_hook(&tcp_obfuscation_ops_ipv6_outgoing);
}
